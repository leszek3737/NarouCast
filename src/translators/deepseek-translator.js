  ...
  async translateText(text, type = 'content') {
    ...
    const requestBody = {
      ...
      messages: [
        {
          role: 'system',
          content: 'Jesteś profesjonalnym tłumaczem literatury japońskiej na język polski. Twoim zadaniem jest przetłumaczenie tekstu zachowując oryginalny ton, styl i nastrój wypowiedzi. Nie dodawaj żadnych komentarzy ani wyjaśnień - zwracaj tylko przetłumaczony tekst.'
        },
        {
          role: 'user',
          content: prompt
...
Zwróć tylko przetłumaczony tekst bez żadnych dodatkowych komentarzy.`;
  ...
  static validateApiKey(apiKey) {
    ...
    if (!apiKey.startsWith('sk-')) {
      throw new Error('Nieprawidłowy format klucza API DeepSeek (powinien zaczynać się od "sk-")');
    }
