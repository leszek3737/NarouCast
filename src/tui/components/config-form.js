...
import { TRANSLATOR_PROVIDERS, TTS_PROVIDERS, AVAILABLE_VOICES } from '../utils/voices.js';

export function ConfigForm({ config, onSubmit, onCancel }) {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Box flexDirection="column" gap={1}>
        <Text bold color="cyan">Konfiguracja Tłumaczenia</Text>
        ...
        <Text bold color="cyan" marginTop={1}>Konfiguracja Text-to-Speech</Text>
        ...
        <Text bold color="cyan" marginTop={1}>Ustawienia Ogólne</Text>
